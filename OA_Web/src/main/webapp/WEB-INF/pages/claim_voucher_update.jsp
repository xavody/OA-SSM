    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" modelAttribute="claimVoucherInfo"
                           action="/claim_voucher/updateTo">
                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row" id="items">
                            <c:forEach items="${claimVoucherInfo.items}" varStatus="sta">
                                <div>
                                    <div class="col-md-3">
                                        <label for="items[${sta.index}].item" class="field prepend-icon">
                                            ...
                                            <form:select path="items[${sta.index}].item" cssClass="gui-input" placeholder="花销类型..."
                                                         items="${items}"/>
                                        </label>
                                    </div>
                                    <div class="col-md-3">
